...
/// @notice Cleanverse Compliance Validator interface from the pinned CCP CVI guide.
/// @dev Do not change field order or widths. They define the RuleV2 ABI tuple.
