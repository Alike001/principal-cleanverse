...
export const authorityNodes: Record<AuthorityNode, { title: string; detail: string; state: "verified" | "blocked" }> = {
  ...
  asset: { title: "Cleanverse aUSDC", detail: "Recorded proof shows a 1.00 aUSDC funding transfer entered the CVI-registered vault, then Passport #1 returned 0.60 aUSDC within its cumulative allowance.", state: "verified" },
};
...
export const authorityChecks = [
  ...
  { label: "Passport transfer", value: "0.60 aUSDC consumed", state: "verified" },
] as const;
