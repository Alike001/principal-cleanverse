...
export const authorityNodes: Record<AuthorityNode, { title: string; detail: string; state: "verified" | "blocked" }> = {
  ...
  asset: { title: "Cleanverse aUSDC", detail: "The vault has a Cleanverse CVI for Monad aUSDC. No CVA balance or transfer is claimed.", state: "verified" },
};
...
export const authorityChecks = [
  ...
  { label: "Validator pool", value: "CVI registered", state: "verified" },
] as const;
